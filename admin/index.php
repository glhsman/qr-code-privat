...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @media (max-width: 768px) {
    ...
    main { margin: 1rem auto; gap: 1rem; padding: 0 .5rem; }
    .card { padding: 1.25rem 1rem; width: 100%; overflow: hidden; }
    .stats { flex-direction: column; }
    .msg-table thead { display: none; }
    .msg-table tr { display: block; margin-bottom: 1rem; border: 1px solid #e5e7eb; border-radius: 8px; padding: .5rem; background: #fdfdfd; }
    .msg-table td { display: block; border: none; padding: .4rem .5rem; width: 100%; }
    .msg-table td::before { content: attr(data-label); font-weight: 600; color: #6b7280; display: block; font-size: .7rem; text-transform: uppercase; margin-bottom: .1rem; }
    .msg-table td[data-label="Aktionen"] { display: flex; flex-wrap: wrap; gap: .4rem; border-top: 1px solid #eee; margin-top: .5rem; padding-top: .8rem; }
    .msg-table td[data-label="Aktionen"]::before { width: 100%; }
    
    .scan-table-wrapper { overflow-x: auto; -webkit-overflow-scrolling: touch; margin: 0 -0.5rem; padding: 0 0.5rem; }
    .form-row { grid-template-columns: 1fr; gap: 0; }
    .toolbar { flex-wrap: wrap; }
    .act-btn { margin: 0; }
  }
  @media (max-width: 480px) {
    header { padding: .8rem 1rem; flex-direction: column; gap: .5rem; text-align: center; }
...
<main>
  ...
  <div class="card">
    ...
    <form method="post" action="save.php">
      ...
      <p class="hint">Zeitraum und tägliche Zeit können kombiniert werden. Ohne Zeitraum/Zeit ist die Meldung inaktiv.</p>
